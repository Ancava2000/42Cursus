...
/*   Updated: 2024/10/16 14:55:32 by acarro-v         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

/* This function sorts and pushes nodes to stack "b"
until there are only three nodes in stack "a". 
First it finds the rotate case with the less moves. 
Then it applies the correct case and exits the second loop
(the apply case function returns -1) */
